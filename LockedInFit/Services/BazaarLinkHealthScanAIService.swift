...
/// Real product-label analysis via AIGatewayClient (OpenRouter, falling
/// back to BazaarLink). Sends the photo, demands strict JSON back, parses
/// into HealthScanEstimate.
